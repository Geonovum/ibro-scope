...
- Van de WOZ komt alleen het WOZ-deelobject erin. De rest van de WOZ is buiten scope.
...
- Bij voorkeur alle inhoud die niet in de Eisen aan model samenhangende objectenregistratie [[EMSO]] beschreven is. Het informatiemodel wordt zo opgezet dat het uitbreidbaar is met objecttypen en kenmerken die nu buiten scope zijn maar op enig moment later in de tijd wel relevant zijn.
